...
// Package alias picks items from a discrete distribution
...
// New function Create a new alias object.
// For example,
//
...
// Gen Generates a random number according to the distribution using the rng passed.
